                ...
                <div class="card-body">
                   ...
                   {{method_field('PUT')}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="nom_per" type="text" class="form-control{{ $errors->has('nom_per') ? ' is-invalid' : '' }}" name="nom_per" value="{{ ($patients->nom_per) }}" required autofocus>
                    ...
                    <div class="form-group row">
                         ...
                         <div class="col-md-6">
                             <input id="prenom_per" type="text" class="form-control{{ $errors->has('prenom_per') ? ' is-invalid' : '' }}" name="prenom_per" value="{{ $patients->prenom_per }}" required autofocus>
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-md-6">
                             <input id="date_naissance" type="date" class="form-control{{ $errors->has('date_naissance') ? ' is-invalid' : '' }}" name="date_naissance" value="{{ $patients->date_naissance }}" required autofocus>
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-md-6">
                             <input id="contact_per" type="tel" class="form-control{{ $errors->has('contact_per') ? ' is-invalid' : '' }}" name="contact_per" value="{{ old('contact_per')?: $patients->contact_per }}" required autofocus>
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-md-6">
                             <input id="adresse_per" type="text" class="form-control{{ $errors->has('adresse_per') ? ' is-invalid' : '' }}" name="adresse_per" value="{{ $patients->adresse_per }}" required autofocus>
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-md-6">
                             <input id="email_per" type="email" class="form-control{{ $errors->has('email_per') ? ' is-invalid' : '' }}" name="email_per" value="{{ $patients->email_per }}" required autofocus>
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-md-6">
                             <input id="code_postal_pat" type="text" class="form-control{{ $errors->has('code_postal_pat') ? ' is-invalid' : '' }}" name="code_postal_pat" value="{{ $patients->code_postal_pat }}" required autofocus>
                    ...
                    <!-- <div class="form-group row">
                         ...
                         <div class="col-md-6">
                             <input id="age_pat" type="number" class="form-control{{ $errors->has('age_pat') ? ' is-invalid' : '' }}" name="age_pat" value="{{ $patients->age_pat }}" required autofocus>
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-md-6">
                             <input id="profession_pat" type="text" class="form-control{{ $errors->has('profession_pat') ? ' is-invalid' : '' }}" name="profession_pat" value="{{ $patients->profession_pat }}" required autofocus>
